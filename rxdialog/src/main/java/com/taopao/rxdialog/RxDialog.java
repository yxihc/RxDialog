...
import com.taopao.rxdialog.internal.MDButton;
import com.taopao.rxdialog.internal.MDRootLayout;
...
import com.taopao.rxdialog.util.RippleHelper;
import com.taopao.rxdialog.util.TypefaceHelper;
...
public class RxDialog extends DialogBase
  ...
  protected RxDialog(Builder builder) {
  ...
  public boolean onItemSelected(
          RxDialog dialog, View view, int position, CharSequence text, boolean longPress) {
    if (!view.isEnabled()) {
      return false;
    }
  ...
  /**
   * Retrieves the custom view that was inflated or set to the RxDialog during building.
   *
  ...
  public final void setItems(CharSequence... items) {
    if (builder.adapter == null) {
      throw new IllegalStateException(
          "This RxDialog instance does not "
        ...
        new TextWatcher() {
          ...
          public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (builder.alwaysCallInputCallback) {
              builder.inputCallback.onInput(RxDialog.this, s);
            }
          }
  ...
  public interface ListCallbackSingleChoice {
     ...
     */
    boolean onSelection(RxDialog dialog, View itemView, int which, CharSequence text);
  }
  ...
  /** The class used to construct a RxDialog. */
  ...
  public static class Builder {
     ...
     *     progress bar is shown that is incremented or set via the built RxDialog instance.
    ...
    @UiThread
    public RxDialog show() {
      RxDialog dialog = build();
      dialog.show();
      return dialog;
    }
  }
  ...
  public abstract static class ButtonCallback {
    ...
    @Deprecated
    public void onAny(RxDialog dialog) {}

    @Deprecated
    public void onPositive(RxDialog dialog) {}

    @Deprecated
    public void onNegative(RxDialog dialog) {}

    // The overidden methods below prevent Android Studio from suggesting that they are overidden by developers

    @Deprecated
    public void onNeutral(RxDialog dialog) {}
