...
import com.taopao.rxdialog.internal.MDAdapter;
...
/**
 * Used by RxDialog while initializing the dialog. Offloads some of the code to make the main
...
class DialogInit {
  ...
  @StyleRes
  static int getTheme(@NonNull RxDialog.Builder builder) {
    boolean darkTheme =
  ...
  @LayoutRes
  static int getInflateLayout(RxDialog.Builder builder) {
  ...
  @UiThread
  static void init(final RxDialog dialog) {
    final RxDialog.Builder builder = dialog.builder;
    ...
    if (dialog.recyclerView != null) {
      if (builder.adapter == null) {
        ...
        if (builder.listCallbackSingleChoice != null) {
          dialog.listType = RxDialog.ListType.SINGLE;
        } else if (builder.listCallbackMultiChoice != null) {
          dialog.listType = RxDialog.ListType.MULTI;
          ...
          dialog.listType = RxDialog.ListType.REGULAR;
        }
        builder.adapter =
            new DefaultRvAdapter(dialog, RxDialog.ListType.getLayoutForType(dialog.listType));
  ...
  private static void setupProgressDialog(final RxDialog dialog) {
    final RxDialog.Builder builder = dialog.builder;
  ...
  private static void setupInputDialog(final RxDialog dialog) {
    final RxDialog.Builder builder = dialog.builder;
